...
class Cadastropermissoes {
    ...
    public function index($msg=""){
        ...
        if ($per->verificarLogin()){
            ...
            $view = new \App\Views\Cadastropermissoes\Cadastropermissoes();
            $model = new \App\Models\BLL\Cadastropermissoes();
    ...
    public function salvar(){
        $model = new \App\Models\BLL\Cadastropermissoes();
        $model->salvar();
        header("refresh: 2; url=http://$_SERVER[HTTP_HOST]/cadastropermissoes");
