...
class Cadastrostatusprojeto {
    ...
    public function index($msg=""){
        ...
        if ($per->verificarLogin()){
            ...
            $view = new \App\Views\Cadastrostatusprojeto\Cadastrostatusprojeto();
            $model = new \App\Models\BLL\Cadastrostatusprojeto();
    ...
    public function salvar(){
        $model = new \App\Models\BLL\Cadastrostatusprojeto();
        $model->salvar();
        header("refresh: 2; url=http://$_SERVER[HTTP_HOST]/cadastrostatusprojeto");
