...
class Cadastrosemestre {
    ...
    public function index($msg=""){
        ...
        if ($per->verificarLogin()){
            ...
            $view = new \App\Views\Cadastrosemestre\Cadastrosemestre();
            $model = new \App\Models\BLL\Cadastrosemestre();
    ...
    public function salvar(){
        $model = new \App\Models\BLL\Cadastrosemestre();
        $model->salvar();
        header("refresh: 2; url=http://$_SERVER[HTTP_HOST]/cadastrosemestre");
